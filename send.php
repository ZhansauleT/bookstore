...
try {
    ...
    $mail->Username   = 'zns919397@gmail.com'; // Логин на почте
    $mail->Password   = 'IphoneIphone919397'; // Пароль на почте
    $mail->SMTPSecure = 'ssl';
    $mail->Port       = 465;
    $mail->setFrom('zns919397@gmail.com', 'Zhansaule Telisheva'); // Адрес самой почты и имя отправителя
